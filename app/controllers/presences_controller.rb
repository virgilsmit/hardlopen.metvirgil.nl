class PresencesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to presences_path, status: :see_other, notice: "Presence was successfully destroyed." }
  ...
  private
    ...
    def presence_params
      params.require(:presence).permit(:session_id, :name, :user_id, :status)
    end
end
