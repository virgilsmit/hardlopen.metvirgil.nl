...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference("Performance.count") do
      post performances_url, params: { performance: { date: @performance.date, notes: @performance.notes, test_type: @performance.test_type, user_id: @performance.user_id, value: @performance.value } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { date: @performance.date, notes: @performance.notes, test_type: @performance.test_type, user_id: @performance.user_id, value: @performance.value } }
