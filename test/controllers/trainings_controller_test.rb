...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference("Training.count") do
      post trainings_url, params: { training: { date: @training.date, location: @training.location, notes: @training.notes } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { date: @training.date, location: @training.location, notes: @training.notes } }
